...
import com.chromedata.incentives.extract.postprocess.rules.engine.CSVFormatter;
import com.chromedata.incentives.extract.postprocess.rules.engine.CSVMappers;
...
import com.chromedata.incentives.extract.postprocess.rules.model.Definition;
...
public class PostProcessorTest {
    ...
    private static List<Rule> parseRules(ExtractVersion extractVersion) throws IOException {
        try (InputStream ymlResourceStream = PostProcessorTest.class.getClassLoader().getResourceAsStream("rules/" + extractVersion.getRuleYML())) {
            return Arrays.asList(MAPPER.readValue(ymlResourceStream, com.chromedata.incentives.extract.postprocess.rules.model.Rule[].class));
        }
    }
