...
import com.contribute.xtrct.postprocess.utils.PostProcessorTestUtils;
...
public class RuleEngineTest {
    ...
    private void validateFifthRule(final Rule rule) {
        ...
        Assert.assertEquals(rule.getDefinition().getOperation(), Operation.UPDATE_RECORDS);
    ...
    private void validateFourthRule(final Rule rule) {
        ...
        Assert.assertEquals(rule.getDefinition().getOperation(), Operation.REMOVE_ROWS);
        Criteria criteria = new Criteria();
