...
import static com.chromedata.incentives.extract.batch.component.ExtractConstants.EXIT_STATUS_SUCCESS;
    ...
    public void run(final String... args) {
        try {
            ...
            JobParameters jobParameter = jobParametersBuilder
                .addString(LANGUAGE, locale.getLanguage())
                .addString(COUNTRY, locale.getCountry())
                .toJobParameters();
            ...
            System.exit((Integer) jobExecution.getExecutionContext().get(COMPLETE_STATUS));
