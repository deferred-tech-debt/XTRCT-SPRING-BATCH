...
import com.contribute.xtrct.dao.lookup.model.IncentiveType;
...
import com.contribute.xtrct.dao.lookup.model.TaxRule;
...
public class BatchDataSet {
    ...
    public void setTaxRuleList(List<TaxRule> taxRuleList) {
