...
public class ExtractVehicleWriter extends ExtractAbstractWriter<CompleteIncentive> {
    ...
    public void write(final List<? extends CompleteIncentive> completeIncentives) throws Exception {
        ...
        synchronized (ExtractVehicleWriter.class) {
            final Set<String> usedAcodes = Objects.nonNull(jobExecutionContext.get(ExtractConstants.ACODES_DEALER)) ? (Set<String>) jobExecutionContext.get(
                ExtractConstants.ACODES_DEALER) : new HashSet<>();
            ...
            jobExecutionContext.put(ExtractConstants.ACODES_DEALER, usedAcodes);
        }
    ...
    private void writeVehicle(final List<com.contribute.xtrct.dao.model.Vehicle> vehicleList) {
        ...
        ExtractConstants.VEHICLE_CONSUMER_COUNT.getAndAdd(data.getVehicleList().size());
