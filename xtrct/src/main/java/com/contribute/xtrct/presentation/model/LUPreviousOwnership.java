...
public class LUPreviousOwnership implements Comparable<LUPreviousOwnership>{

    private static final IdentityGenerator IDENTITY = IdentityGenerators.createIdentityGenerator(LUPreviousOwnership.class);
    ...
    public LUPreviousOwnership(final Integer id, final String description) {
        this.id = id;
    ...
    @Override
    public int compareTo(final LUPreviousOwnership o) {
        if (o == this) {
            return 0;
        }
